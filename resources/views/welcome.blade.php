...
<head>
    ...
    <title>Katori Danh</title>

    <link href="{{asset('public/frontend/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/frontend/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/frontend/css/pretty{{Photo.css')}}" rel="stylesheet">
...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +84 978 224 157</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> ledobadanh123@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="#">GIÀNH CHO GIA ĐÌNH</a></h4>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="#"> <span class="pull-right">(32)</span>..</a></li>
    ...
    <footer id="footer"><!--Footer-->
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="single-widget">
                            <h2>THÔNG TIN</h2>
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="#">Giới thiệu xưởng giày</a></li>
                                <li><a href="#">Liên hệ </a></li>
                                <li><a href="#">Hệ thống của hàng</a>
                                    <ul class="nav nav-pills nav-stacked">
                                        <li><i class="fas fa-location-arrow"> 99 Trần Bình</i></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2020 Katori Danh</p>
                    <p class="pull-right">Designed by <span><a target="_blank" href="https://www.facebook.com/anhdanh1998">Lê Đỗ Bá Danh</a></span></p>
                </div>
            </div>
        </div>
